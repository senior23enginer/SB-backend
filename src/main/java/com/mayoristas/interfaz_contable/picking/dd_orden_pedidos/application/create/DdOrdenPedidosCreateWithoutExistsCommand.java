...
/**
 * Comando de aplicación para crear {@link com.mayoristas.interfaz_contable.picking.dd_orden_pedidos.domain.DdOrdenPedidos}
 * validando previamente que no exista por llave primaria.
 */
public class DdOrdenPedidosCreateWithoutExistsCommand extends CreateDdOrdenPedidosCommand {

    public DdOrdenPedidosCreateWithoutExistsCommand(Long codigoEmpresa, Long loCodigoDesp, String checkComuna, String checkMarca, String checkProducto, String indAndOrProd, String indIncExc, String checkStock, String sinStock, String conStock, String checkCantProd, Long cantProdDesde, Long cantProdHasta, String checkPrecio, Long precioDesde, Long precioHasta, LocalDateTime fechaCreacion, String creadoPor, LocalDateTime fechaActualicacion, String actualizadoPor) {
